...
splot "/home/primat/projects/tests/new_struct/sources/ring/H1_W10_P10/real/stress/yy.gpd" using ($1):($2):($3) with pm3d

#set title "Stress {/Symbol s}_{xx} for R = 0.3" font "Serif, 30"
set output "ring_fig/stress_yy_H.png"
splot "/home/primat/projects/tests/new_struct/sources/ring/H10_W1_P1/real/stress/yy.gpd" using ($1):($2):($3) with pm3d

set output "ring_fig/stress_zz_W.png"
splot "/home/primat/projects/tests/new_struct/sources/ring/H1_W10_P10/real/stress/zz.gpd" using ($1):($2):($3) with pm3d

set output "ring_fig/stress_zz_H.png"
splot "/home/primat/projects/tests/new_struct/sources/ring/H10_W1_P1/real/stress/zz.gpd" using ($1):($2):($3) with pm3d
