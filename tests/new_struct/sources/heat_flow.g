...
set xtics ("20" 0.0, "20.5" 0.25, "21.5" 0.75, "22" 0.99) font "Monospace, 30" out
...
set title "{q}_{x}" font "Serif, 30"
set output "heat_flow.png"
#set zrange [-0.22:-0.04]
splot "ring_heat/real/q_x.gpd" using ($1):($2):($3) with pm3d


set zrange [1:10]
set title "T}" font "Serif, 30"
set output "T.png"
#set zrange [-0.22:-0.04]
splot "ring_heat/real/T.gpd" using ($1):($2):($3) with pm3d
