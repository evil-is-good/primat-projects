...
set output "../res/stress_cell_010_vx_xz.png"
set origin 0.01,0.01
set size 0.99, 0.99
set xrange [ 0 : 0.01 ]
#set zrange [ 0.01 : 1 ]
...
# \n Рис.3. Сравнение макротеплопроводности ячейки для \n включений различной формы
set xlabel "{/Symbol x}_X" font "Monospace, 50"
set ylabel "{/Serif=50 {/Symbol t}_{xz}^{v_x k=(0,1,0)}}" font "Monospace, 25" offset 2
...
set output "../res/stress_cell_010_vz_xx.png"
set origin 0.01,0.01
set size 0.99, 0.99
set xrange [ 0 : 0.01 ]
#set zrange [ 0.01 : 1 ]
...
# \n Рис.3. Сравнение макротеплопроводности ячейки для \n включений различной формы
set xlabel "{/Symbol x}_X" font "Monospace, 50"
set ylabel "{/Serif=50 {/Symbol t}_{xx}^{v_z k=(0,1,0)}}" font "Monospace, 25" offset 2
...
set output "../res/stress_cell_010_vz_zz.png"
set origin 0.01,0.01
set size 0.99, 0.99
set xrange [ 0 : 0.01 ]
#set zrange [ 0.01 : 1 ]
...
# \n Рис.3. Сравнение макротеплопроводности ячейки для \n включений различной формы
set xlabel "{/Symbol x}_X" font "Monospace, 50"
set ylabel "{/Serif=50 {/Symbol t}_{zz}^{v_z k=(0,1,0)}}" font "Monospace, 25" offset 2
