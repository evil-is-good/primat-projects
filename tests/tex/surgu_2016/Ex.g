...
set ylabel "{/Serif=50 {/Symbol s}_{yy}}" font "Monospace, 25" offset 2

plot \
 "../05_8_25_5/final/final_stress_y_y.gpd" u 1:4 w l ti "{/Monospace=20 1 среднее арифметическое {{/Symbol=20 l}_{См}}}" lt 4 lw 3
