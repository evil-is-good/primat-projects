...
\title{Расчет температурного поля обжимного кольца выполненного из композитного волокнистого материала}
...
\text{На внутренней поверхносте кольца задана температура $T_1$,} \text{ на внешней поверхности $T_2$.
Торцы теплоизолированны.}
} 
...
\begin{equation*}
    \mathrm{x_i, y_i} - \text{координаты левого нижнего угла i-ой ячейки}
\end{equation*}
...
\end{equation*}
%
\text{Условие периодичности ячейковых функций}
\begin{equation}
    \begin{array}{c}
...
\begin{equation}
    ...
    \frac{\partial \widetilde{q}_z}{\partial z}\varepsilon + Q = 0
\end{equation}

\text{Закон Фурье}
\begin{equation}
    \widetilde{q}_{\alpha} = \sum\limits_{\beta \in \{x,y\}} 
    \widetilde{\lambda}_{\alpha \beta} 
        \frac{\partial T}{\beta}\varepsilon, \alpha \in \{x,y,z\}
\end{equation}
...
\frame{ \frametitle{Напряжения $\sigma_{\theta\theta}$} 

\begin{figure}[h]
    \begin{center}
        \begin{minipage}[h]{0.4\linewidth}
            \includegraphics[width=1\linewidth]{../stress_yy_W} \\ \center{Широкое кольцо}
            % \caption{Кольцо.} %% подпись к рисунку
        \end{minipage}
        \hfill 
        \begin{minipage}[h]{0.4\linewidth}
        \includegraphics[width=1\linewidth]{../stress_yy_H} \\ \center{Узкое кольцо}
...
\frame{ \frametitle{Напряжения $\sigma_{\theta\theta}$ в одной ячейке} 

\begin{figure}
    \begin{center}
        \includegraphics[scale=0.3]{../stress_yy_H_cell}
    \end{center}
\end{figure}
}

\frame{ \frametitle{Напряжения $\sigma_{\theta\theta}$ и $\sigma_{zz}$ в одной ячейке} 

\begin{figure}[h]
    \begin{center}
        \begin{minipage}[h]{0.4\linewidth}
            \includegraphics[width=1\linewidth]{../cell_yy} \\ \center{$\sigma_{\theta\theta}$}
            % \caption{Кольцо.} %% подпись к рисунку
        \end{minipage}
        \hfill 
        \begin{minipage}[h]{0.4\linewidth}
            \includegraphics[width=1\linewidth]{../cell_zz} \\ \center{$\sigma_{zz}$}
        %\\ \center{Поперечное сечение кольца}
            % \caption{Сечение кольца.}
        \end{minipage}
    \end{center}
...
\frame{ \frametitle{Сравнение напряжений $\sigma_{\theta\theta}$ для широкого и узкого колец} 

    \begin{figure}[h]
        \begin{center}
            \begin{minipage}[h]{0.4\linewidth}
                \includegraphics[width=1\linewidth]{../stress_line_yy_W} \\ \center{Широкое кольцо}
                % \caption{Кольцо.} %% подпись к рисунку
            \end{minipage}
            \hfill 
            \begin{minipage}[h]{0.4\linewidth}
                \includegraphics[width=1\linewidth]{../stress_line_yy_H} \\ \center{Узкое кольцо}
                %\\ \center{Поперечное сечение кольца}
                % \caption{Сечение кольца.}
            \end{minipage}
        \end{center}
...
\frame{ \frametitle{Сравнение напряжений $\sigma_{zz}$ для широкого и узкого колец} 

    \begin{figure}[h]
        \begin{center}
            \begin{minipage}[h]{0.4\linewidth}
                \includegraphics[width=1\linewidth]{../stress_line_zz_W} \\ \center{Широкое кольцо}
                % \caption{Кольцо.} %% подпись к рисунку
            \end{minipage}
            \hfill 
            \begin{minipage}[h]{0.4\linewidth}
                \includegraphics[width=1\linewidth]{../stress_line_zz_H} \\ \center{Узкое кольцо}
                %\\ \center{Поперечное сечение кольца}
                % \caption{Сечение кольца.}
            \end{minipage}
        \end{center}
