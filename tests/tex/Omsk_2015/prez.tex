...
\title{Влияние внутренней структуры волокнистых композитов на концентрацию напряжений вблизи отверстий}
...
\begin{figure}
    \begin{center}
        \includegraphics[scale=0.45]{hole}
    \end{center}
\end{figure}
...
\begin{equation}
\mathrm{
    \Bigl.\sigma_{yy}\Bigr|_{y=0} = -1,
    \Bigl.\sigma_{yy}\Bigr|_{y=1} = 1,
}
\end{equation}
} 
...
\frame{ \frametitle{Пластина изготовленная из однородного макроматериала с вырезанным круглым отверстием} 

\begin{figure}
    \begin{center}
        \includegraphics[scale=0.4]{hole_macro}
    \end{center}
\end{figure}
