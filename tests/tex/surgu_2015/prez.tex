...
\title{Исследование напряженного состояния в периодическом композитном материале вблизи отверстия}
...
\frame{ \frametitle{Пластина изготовленная из волокнистого материала с вырезанным круглым отверстием} 

\begin{figure}
    \begin{center}
        \includegraphics[scale=0.5]{text6105}
    \end{center}
\end{figure}
...
\frame{ \frametitle{Бесконечная пластина из однородного материала с вырезанным круглым отверстием} 

\begin{figure}
    \begin{center}
        \includegraphics[scale=0.4]{text7321-7}
    \end{center}
\end{figure}
% \begin{figure}[h]
%     \begin{center}
...
\frame{ \frametitle{Асимптотическое разложение напряжения, ограниченное n=2} 
