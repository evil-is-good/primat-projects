...
\begin{figure}[H]
  \center
  \includegraphics[width=0.8\linewidth]{stress_zz_H_cell}
\end{figure}
\end{frame}
...
\begin{figure}[h]
  \begin{minipage}[h]{0.49\linewidth}
    ...
    \center{\includegraphics[width=1\linewidth]{stress_zz_H_cell}}
  \end{minipage}
  \hfill
  \begin{minipage}[h]{0.49\linewidth}
...
\begin{figure}[H]
  \center
    \includegraphics[width=0.4\linewidth]{stress_zz_H_cell}
    \includegraphics[width=0.4\linewidth]{stress_zz_H_cell}\\
    \includegraphics[width=0.4\linewidth]{stress_zz_H_cell}
    \includegraphics[width=0.4\linewidth]{stress_zz_H_cell}
\end{figure}
